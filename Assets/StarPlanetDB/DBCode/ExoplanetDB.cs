...
public class ExoplanetDB : MonoBehaviour
{
    ...
    List<Exoplanet_Data_PlanetsData> PlanetsForStar(Exoplanet_StarsUnique2Data star)
    {
    ...
    List<Exoplanet_Data_PlanetsData> PlanetsForStarNamed(string starName)
    {
        //List<Exoplanet_Data_PlanetsData> planetLists =
        var planetLists =
            from p in planets.dataArray
    ...
    List<Exoplanet_StarsUnique2Data> starsWithEarthSizePlanets()
    {
